...
### Fixed
- Corrected version number in binary to match release tag (was showing 0.1.0, now shows 0.0.3)
- Fixed version check in updater to properly detect new releases
